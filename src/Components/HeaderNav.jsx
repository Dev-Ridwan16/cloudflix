  ...
  return (
    <React.Fragment>
      <div className= {`${handleTheme ? 'bg-[#070101] transition-all duration-1000 ease-in-out' : 'bg-[#ffffff] text-[#070101]'} z-30 py-2 h-[50px] md:w-screen lg:hidden sticky top-0`}>
        ...
        <div>
          <nav className={`${nav ? 'opacity-0 w-0' : 'opacity-100 w-screen'} transition-all duration-500 ease-in-out flex flex-col h-screen fixed ${handleTheme ? 'bg-[#070101] transition-all duration-1000 ease-in-out' : 'bg-[#ffffff]'}`}>
